...
public class RoleInitializer implements ApplicationListener<ContextRefreshedEvent> {
  ...
  public RoleInitializer(final RoleRepository roleRepository, final UserRepository userRepository,
  ...
  public void onApplicationEvent(final ContextRefreshedEvent contextRefreshedEvent) {
    final Role role = new Role("ADMIN", LocalDateTime.now().plusYears(5), List.of());
