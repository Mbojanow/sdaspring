...
public class ParkingLotController {
  ...
  //BRAK @VALID
  public ParkingLot updatePartially(@PathVariable("id") final Long id, @RequestBody final ParkingLot parkingLot) {
    return parkingLotService.updatePartially(id, parkingLot);
  }
}
